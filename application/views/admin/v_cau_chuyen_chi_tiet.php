                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="main-card mb-12 card" style="width:100%">
                                <div class="card-body"><h3 class="card-title" style="font-size:18px;"><?=$cau_chuyen->tieu_de;?></h3>
                                    <div>
                                        <div>
                                            <div style="display: inline-block;">
                                                <span style="font-weight:500;">Người đăng:</span>
                                                <span><?=$cau_chuyen->tac_gia;?></span>
                                            </div>
                                        ...
                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label" style="font-weight:500;">Mô tả:</label>
                                            <div class="col-sm-10"><?=$cau_chuyen->mo_ta;?></div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label" style="font-weight:500;">Nội dung:</label>
                                            <div class="col-sm-10"><?=$cau_chuyen->noi_dung;?></div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label" style="font-weight:500;">Ghi chú:</label>
                                            <div class="col-sm-10"><?=$cau_chuyen->ghi_chu;?></div>
                                        </div>

                                        <div class="position-relative row form-check">
                                            <div class="" style="text-align: right; margin-right: 15px;">
                                                <a href="<?=base_url();?>admin/Quan_tri_cau_chuyen" class="btn btn-danger">Quay trở lại</a>    
                                                <a href="<?=base_url();?>admin/Quan_tri_cau_chuyen/sua/<?=$cau_chuyen->id;?>" class="btn btn-danger">Sửa bài viết</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
