                ...
                <div class="app-main__inner">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body py-3">        
                            <div class="row no-gutters align-items-center">
                                <div class="col"><a href="<?=base_url();?>admin/quan_tri_thu_cung/xem/<?=$row->id;?>" class="text-big font-weight-semibold"><?=$row->ten_pet;?></a></div>
                                <div class="d-none d-md-block col-6">        
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-3">
                                            <a href="<?=base_url();?>admin/quan_tri_thu_cung/sua/<?=$row->id;?>">
                                            <button class="ladda-button mb-2 mr-2 btn btn-danger" data-style="expand-right">
                                            ...
                                            <a href="<?=base_url();?>admin/quan_tri_thu_cung/xoa/<?=$row->id;?>">
                                            <button class="ladda-button mb-2 mr-2 btn btn-danger" data-style="expand-right">
