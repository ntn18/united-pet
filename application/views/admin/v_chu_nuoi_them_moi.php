                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="main-card mb-12 card" style="width:100%">
                                <div class="card-body"><h5 class="card-title" style="font-size:20px;">THÊM MỚI CHỦ NUÔI</h5>
                                    <div>
                                    <form method="POST" enctype="multipart/form-data" action="<?=base_url().'admin/quan_tri_chu_nuoi/thuc_hien_them_moi_chu_nuoi';?>">

                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Họ tên</label>
                                            <div class="col-sm-10">
                                                <input name="txtHoTen" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-check">
                                            <div class="" style="text-align: right; margin-right: 15px;">
                                                ...
                                                <button class="btn btn-danger" onclick="alert('Chủ nuôi đã được thêm mới thành công!')">Xác nhận</button>
                                            </div>
                                        </div>
                                    </form>
                                    </div>
