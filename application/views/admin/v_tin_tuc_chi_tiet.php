                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="main-card mb-12 card" style="width:100%">
                                <div class="card-body"><h3 class="card-title" style="font-size:18px;"><?=$tin_tuc->tieu_de;?></h3>
                                    <div>
                                        <div>
                                            <div style="display: inline-block;">
                                                <span style="font-weight:500;">Người đăng:</span>
                                                <span><?=$tin_tuc->tac_gia;?></span>
                                            </div>
                                            <div style="display: inline-block; margin-left: 100px;">
                                                <span style="font-weight:500;">Thời gian:</span>
                                                <span><?=$tin_tuc->ngay_dang;?></span>
                                            </div>
                                        </div>

                                        <div class="position-relative row form-group">
                                            <div class="col-sm-12" style="text-align: center;">
                                                <img src="<?=base_url()."assets/images/news/".$tin_tuc->anh_minh_hoa;?>" style="width: auto; height: auto; margin-top: 30px;";?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label" style="font-weight:500;">Mô tả:</label>
                                            <div class="col-sm-10"><?=$tin_tuc->mo_ta;?></div>
                                        </div>

                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label" style="font-weight:500;">Nội dung:</label>
                                            <div class="col-sm-10"><?=$tin_tuc->noi_dung;?></div>
                                        </div>

                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label" style="font-weight:500;">Ghi chú:</label>
                                            <div class="col-sm-10"><?=$tin_tuc->ghi_chu;?></div>
                                        </div>

                                        <div class="position-relative row form-check">
                                            <div class="" style="text-align: right; margin-right: 15px;">
                                                <a href="<?=base_url();?>admin/Quan_tri_tin_tuc" class="btn btn-danger">Quay trở lại</a>    
                                                <a href="<?=base_url();?>admin/quan_tri_tin_tuc/sua/<?=$tin_tuc->id;?>" class="btn btn-danger">Sửa bài viết</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
