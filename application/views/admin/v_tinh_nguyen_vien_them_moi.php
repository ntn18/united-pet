                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="main-card mb-12 card" style="width:100%">
                                <div class="card-body"><h5 class="card-title" style="font-size:20px;"> Đăng kí tình nguyện viên</h5>
                                    <div>
                                    <form method="POST" enctype="multipart/form-data" action="<?=base_url().'admin/quan_tri_tinh_nguyen_vien/thuc_hien_them_moi_tinh_nguyen_vien';?>">
