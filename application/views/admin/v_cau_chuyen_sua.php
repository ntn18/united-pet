                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="main-card mb-12 card" style="width:100%">
                                <div class="card-body"><h3 class="card-title" style="font-size:20px;">SỬA CÂU CHUYỆN</h3>
                                    <div>
                                    <form method="POST" enctype="multipart/form-data" action="<?=base_url().'admin/quan_tri_cau_chuyen/thuc_hien_sua_cau_chuyen';?>">
                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Tiêu đề</label>
                                            <div class="col-sm-10">
                                                <input name="txtTieuDe" class="form-control" value="<?=$cau_chuyen->tieu_de;?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Mô tả</label>
                                            <div class="col-sm-10">
                                                <textarea name="txtMoTa" rows="5" class="form-control"><?=$cau_chuyen->mo_ta;?></textarea>
                                            </div>
                                        </div>

                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Nội dung</label>
                                            <div class="col-sm-10">
                                                <textarea name="txtNoiDung" rows="50" class="form-control"><?=$cau_chuyen->noi_dung;?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-check">
                                            <div class="" style="text-align: right; margin-right: 15px;">
                                                ...
                                                <input name="txtID" type="hidden" value="<?=$cau_chuyen->id;?>">
                                            </div>
                                        </div>
