                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="main-card mb-12 card" style="width:100%">
                                <div class="card-body"><h3 class="card-title" style="font-size:20px;">SỬA THÔNG TIN CHỦ NUÔI</h3>
                                    <div>
                                    <form method="POST" enctype="multipart/form-data" action="<?=base_url().'admin/quan_tri_chu_nuoi/thuc_hien_sua_chu_nuoi';?>">
                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Họ tên</label>
                                            <div class="col-sm-10">
                                                <input name="txtHoTen" class="form-control" value="<?=$chu_nuoi->ho_ten;?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Ảnh</label>
                                            <div class="col-sm-10">
                                                ...
                                                <img src="<?=base_url()."assets/images/avatars/".$chu_nuoi->anh;?>" style="width: 200px; height: auto; margin-top: 10px;";?>
                                            </div>
                                        </div>

                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Địa chỉ</label>
                                            <div class="col-sm-10">
                                                <input name="txtDiaChi" class="form-control" value="<?=$chu_nuoi->dia_chi;?>">
                                            </div>
                                        </div>

                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">SĐT</label>
                                            <div class="col-sm-10">
                                                <input name="txtSDT" class="form-control" value="<?=$chu_nuoi->sdt;?>">
                                            </div>
                                        </div>

                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Email</label>
                                            <div class="col-sm-10">
                                                <input name="txtEmail" class="form-control" value="<?=$chu_nuoi->email;?>">
                                            </div>
                                        </div>

                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Số chứng minh thư</label>
                                            <div class="col-sm-10">
                                                <input name="txtCMT" class="form-control" value="<?=$chu_nuoi->cmt;?>">
                                            </div>
                                        </div>

                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">ID thú cưng</label>
                                            <div class="col-sm-10">
                                                <input name="txtPetID" class="form-control" value="<?=$chu_nuoi->pet_id;?>">
                                            </div>
                                        </div>

                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Ghi chú</label>
                                            <div class="col-sm-10">
                                                <input name="txtGhiChu" class="form-control" value="<?=$chu_nuoi->ghi_chu;?>">
                                            </div>
                                        </div>

                                        <div class="position-relative row form-check">
                                            <div class="" style="text-align: right; margin-right: 15px;">
                                                <a href="<?=base_url();?>admin/Quan_tri_chu_nuoi" class="btn btn-danger">Quay trở lại</a>    
                                                <button class="btn btn-danger" onclick="alert('Sửa thông tin thành công!')">Xác nhận</button>
                                                <input name="txtID" type="hidden" value="<?=$chu_nuoi->id;?>">
                                            </div>
                                        </div>
