                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="main-card mb-12 card" style="width:100%">
                                <div class="card-body"><h5 class="card-title" style="font-size:20px;">THÊM MỚI CÂU CHUYỆN</h5>
                                    <div>
                                    <form method="POST" enctype="multipart/form-data" action="<?=base_url().'admin/quan_tri_cau_chuyen/thuc_hien_them_moi_cau_chuyen';?>">

                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Tiêu đề</label>
                                            <div class="col-sm-10">
                                                <input name="txtTieuDe" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Nội dung</label>
                                            <div class="col-sm-10">
                                                <textarea name="txtNoiDung" rows="50" class="form-control"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-check">
                                            <div class="" style="text-align: right; margin-right: 15px;">
                                                ...
                                                <button class="btn btn-danger" onclick="alert('Câu chuyện đã được thêm mới thành công!')">Xác nhận</button>
                                            </div>
                                        </div>
                                    </form>
                                    </div>
