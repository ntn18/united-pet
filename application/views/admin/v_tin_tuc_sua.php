                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="main-card mb-12 card" style="width:100%">
                                <div class="card-body"><h3 class="card-title" style="font-size:20px;">SỬA TIN TỨC</h3>
                                    <div>
                                    <form method="POST" enctype="multipart/form-data" action="<?=base_url().'admin/quan_tri_tin_tuc/thuc_hien_sua_tin_tuc';?>">
                                        ...
                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Ảnh minh họa</label>
                                            <div class="col-sm-10">
                                                ...
                                                <img src="<?=base_url()."assets/images/news/".$tin_tuc->anh_minh_hoa;?>" style="width: 200px; height: auto; margin-top: 10px;";?>
                                            </div>
                                        </div>

                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Mô tả</label>
                                            <div class="col-sm-10">
                                                <textarea name="txtMoTa" rows="5" class="form-control"><?=$tin_tuc->mo_ta;?></textarea>
                                            </div>
                                        </div>

                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Nội dung</label>
                                            <div class="col-sm-10">
                                                <textarea name="txtNoiDung" rows="50" class="form-control"><?=$tin_tuc->noi_dung;?></textarea>
                                            </div>
                                        </div>
