...
<head>
    ...
    <title>Quản trị tin tức | United Pets</title>
...
<span class="ladda-label">Thêm mới
                    ...
                    <div class="card mb-3">
                        <div class="card-header pl-0 pr-0">
                            <div class="row w-100 no-gutters align-items-center">
                                <div class="col font-weight-bold pl-3">Tin khuyến mại</div>
                                <div class="d-none d-md-block col-6 text-muted">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col-3">Threads</div>
                                        <div class="col-3">Replies</div>
                    ...
                    <div class="card mb-3">
                        <div class="card-header pl-0 pr-0">
                            <div class="row w-100 no-gutters align-items-center">
                                <div class="col font-weight-bold">Tin tuyển dụng</div>
                                <div class="d-none d-md-block col-6 text-muted">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col-3">Threads</div>
                                        <div class="col-3">Replies</div>
                    ...
                    <div class="card mb-3">
                        <div class="card-header pl-0 pr-0">
                            <div class="row w-100 no-gutters align-items-center">
                                <div class="col font-weight-bold pl-3">Giới thiệu</div>
                                <div class="d-none d-md-block col-6 text-muted">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col-3">Threads</div>
                                        <div class="col-3">Replies</div>
