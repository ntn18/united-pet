...
<head>
    ...
    <title>Quên mật khẩu | K19HTTTC</title>
                    ...
                    <div class="h-100 d-flex bg-white justify-content-center align-items-center col-md-12 col-lg-8">
                        <div class="mx-auto app-login-box col-sm-12 col-md-8 col-lg-6">
                            ...
                            <h4>
                                ...
                                <span>Điền địa chỉ Email, chúng tôi sẽ gửi bạn đường dẫn khôi phục mật khẩu.</span></h4>
                            <div>
                                <form class="">
                                    <div class="form-row">
                                        <div class="col-md-12">
                                    ...
                                    <div class="mt-4 d-flex align-items-center">
                                        <div class="ml-auto">
                                            <button class="btn btn-primary btn-lg">Khôi phục mật khẩu</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
