                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="main-card mb-12 card" style="width:100%">
                                <div class="card-body"><h3 class="card-title" style="font-size:20px;">SỬA THÔNG TIN CA CỨU HỘ</h3>
                                    <div>
                                    <form method="POST" enctype="multipart/form-data" action="<?=base_url().'admin/quan_tri_cuu_ho/thuc_hien_sua_case';?>">
                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Người báo tin</label>
                                            <div class="col-sm-10">
                                                <input name="ng_bao_tin" class="form-control" value="<?=$cuu_ho->ng_bao_tin;?>">
                                            </div>
                                        </div>

                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Số điện thoại</label>
                                            <div class="col-sm-10">
                                                <input name="sdt" class="form-control" value="<?=$cuu_ho->sdt;?>">
                                            </div>
                                        </div>

                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Địa chỉ cứu hộ</label>
                                            <div class="col-sm-10">
                                                <input name="dia_diem_cuu" class="form-control" value="<?=$cuu_ho->dia_diem_cuu;?>">
                                            </div>
                                        </div>

                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Loại động vật</label>
                                            <div class="col-sm-10">
                                                <select name="loai_pet_id" type ="text" class="form-control">
                                                <option value="1">Chó</option>
                                                <option value="2">Mèo</option></select>
                                            </div>
                                        </div>

                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Tình trạng</label>
                                            <div class="col-sm-10">
                                                <input name="tinh_trang" class="form-control" value="<?=$cuu_ho->tinh_trang;?>">
                                            </div>
                                        </div>

                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Mức độ</label>
                                            <div class="col-sm-10">
                                                <select name="muc_do_id" type ="text" class="form-control">
                                                <option value="1">Nguy hiểm</option>
                                                <option value="2">Bình thường</option></select>
                                            </div>
                                        </div>

                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Tiếp nhận</label>
                                            <div class="col-sm-10">
                                                <select name="tiep_nhan_id" type ="text" class="form-control">
                                                <option value="1">Đã tiếp nhận</option>
                                                <option value="2">Chưa tiếp nhận</option></select>
                                            </div>
                                        </div>

                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Ghi chú</label>
                                            <div class="col-sm-10">
                                                <input name="ghi_chu" class="form-control" value="<?=$cuu_ho->ghi_chu;?>">
                                            </div>
                                        </div>

                                        <div class="position-relative row form-check">
                                            <div class="" style="text-align: right; margin-right: 15px;">
                                                <a href="<?=base_url();?>admin/Quan_tri_cuu_ho" class="btn btn-danger">Quay trở lại</a>    
                                                <button class="btn btn-danger" onclick="alert('Sửa thông tin thành công!')">Xác nhận</button>
                                                <input name="case_id" type="hidden" value="<?=$cuu_ho->case_id;?>">
                                            </div>
                                        </div>
