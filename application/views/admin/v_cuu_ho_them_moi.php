                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="main-card mb-12 card" style="width:100%">
                                <div class="card-body"><h5 class="card-title" style="font-size:20px;">THÊM MỚI CA CỨU HỘ</h5>
                                    <div>
                                    <form method="POST" enctype="multipart/form-data" action="<?=base_url().'admin/quan_tri_cuu_ho/thuc_hien_them_moi_case';?>">

                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Người báo tin</label>
                                            <div class="col-sm-10">
                                                <input name="ng_bao_tin" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Địa điểm cứu hộ</label>
                                            <div class="col-sm-10">
                                                <input name="dia_diem_cuu" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Tình trạng</label>
                                            <div class="col-sm-10">
                                                <input name="tinh_trang" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Tiếp nhận</label>
                                            <div class="col-sm-10">
                                                ...
                                                <option value="2">Chưa tiếp nhận</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Ghi chú</label>
                                            <div class="col-sm-10">
                                                <input name="ghi_chu" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-check">
                                            <div class="" style="text-align: right; margin-right: 15px;">
                                                ...
                                                <button class="btn btn-danger" onclick="alert('Ca cứu hộ đã được thêm mới thành công!')">Xác nhận</button>
                                            </div>
                                        </div>
                                    </form>
                                    </div>
