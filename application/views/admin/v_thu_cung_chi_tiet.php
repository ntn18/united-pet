                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="main-card mb-12 card" style="width:100%">
                                <div class="card-body"><h3 class="card-title" style="font-size:18px;"><?=$thu_cung->ten_pet;?></h3>
                                    <div>
                                        <div>
                                            <div style="display: inline-block;">
                                                <span style="font-weight:500;">Loại Pet:</span>
                                        ...
                                        <div class="position-relative row form-group">
                                            <div class="col-sm-12" style="text-align: center;">
                                                <img src="<?=base_url()."assets/images/pet/".$thu_cung->anh;?>" style="width: auto; height: auto; margin-top: 30px;";?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label" style="font-weight:500;">Chủ nuôi:</label>
                                            <div class="col-sm-10"><?=$thu_cung->chu_nuoi_id;?></div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-check">
                                            <div class="" style="text-align: right; margin-right: 15px;">
                                                ...
                                                <a href="<?=base_url();?>admin/quan_tri_thu_cung/sua/<?=$thu_cung->pet_id;?>" class="btn btn-danger">Sửa bài viết</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
