                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>Quản trị hệ thống
                                    <div class="page-title-subheading">Chào mừng bạn đến với quản trị United Pets.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12 col-md-6 col-xl-4">
                                <div class="card mb-3 widget-chart">
                                    <div class="widget-chart-content">
                                        ...
                                        <div class="widget-subheading fsize-1 pt-2 opacity-10 text-warning font-weight-bold">Ngân sách</div>
                            ...
                            <div class="col-sm-12 col-md-12 col-xl-4">
                                <div class="card mb-3 widget-chart">
                                    <div class="widget-chart-content">
                                        ...
                                        <div class="widget-numbers text-danger"><span>2M</span></div>
                                        <div class="widget-subheading fsize-1 pt-2 opacity-10 text-info font-weight-bold">Chi tiêu</div>
                                        <div class="widget-description opacity-8">
                                            Giảm
