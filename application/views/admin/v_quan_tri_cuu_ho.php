                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            ...
                            <div class="page-title-actions">
                               ...
                               <a href="<?=base_url();?>admin/quan_tri_cuu_ho/them_moi_case">
                        ...
                        <div class="card-body">
                            <table style="width: 100%; text-align:center;" id="example" class="table table-hover table-striped table-bordered">
                                ...
                                <tr>
                                    <td><?=$row->case_id;?></td>
                                    <td><?=$row->ng_bao_tin;?></td>
                                    <td><?=$row->sdt;?></td>
                                    <td><?=$row->dia_diem_cuu;?></td>
                                    <td><?=$row->thoi_gian;?></td>
                                    <td><?=$row->loai_pet_id;?></td>
                                    <td><?=$row->tinh_trang;?></td>
                                    <td><?=$row->muc_do_id;?></td>
                                    <td><?=$row->tiep_nhan_id;?></td>
                                    <td><?=$row->ghi_chu;?></td>
                                    <td>
                                            <a href="<?=base_url();?>admin/quan_tri_cuu_ho/sua/<?=$row->case_id;?>">
                                            <button class="ladda-button mb-2 mr-2 btn btn-danger" data-style="expand-right">
                                            ...
                                            <a href="<?=base_url();?>admin/quan_tri_cuu_ho/xoa/<?=$row->case_id;?>">
                                            <button class="ladda-button mb-2 mr-2 btn btn-danger" data-style="expand-right">
