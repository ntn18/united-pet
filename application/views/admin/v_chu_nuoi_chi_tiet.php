                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="main-card mb-12 card" style="width:100%">
                                <div class="card-body"><h3 class="card-title" style="font-size:18px;">Thông tin chủ nuôi</h3>
                                    <div>
                                        <div class="position-relative row form-group">
                                            <div class="col-sm-12" style="text-align: left;">
                                                <img src="<?=base_url()."assets/images/avatars/".$chu_nuoi->anh;?>" style="width: auto; height: auto; margin-top: 30px;";?>
                                            </div>
                                        </div>
                                        <div>
                                            <div style="display: inline-block;">
                                                <span style="font-weight:500;">Họ tên chủ nuôi:</span>
                                                <span><?=$chu_nuoi->ho_ten;?></span>
                                            </div>
                                            <div style="display: inline-block; margin-left: 100px;">
                                                <span style="font-weight:500;">Số điện thoại:</span>
                                                <span><?=$chu_nuoi->sdt;?></span>
                                            </div>
                                        </div>
                                        ...
                                        <div style="display: inline-block;">
                                                ...
                                                <span><?=$chu_nuoi->dia_chi;?></span>
                                        </div></div>

                                        
                                        <div><div style="display: inline-block;">
                                                <span style="font-weight:500;">Email:</span>
                                                <span><?=$chu_nuoi->email;?></span>
                                        </div></div>

                                        <div><div style="display: inline-block;">
                                                <span style="font-weight:500;">Số chứng minh thư:</span>
                                                <span><?=$chu_nuoi->cmt;?></span>
                                        </div></div>

                                        <div><div style="display: inline-block;">
                                                <span style="font-weight:500;">ID thú cưng:</span>
                                                <span><?=$chu_nuoi->pet_id;?></span>
                                        </div></div>

                                        <div><div style="display: inline-block;">
                                                <span style="font-weight:500;">Ghi chú:</span>
                                                <span><?=$chu_nuoi->ghi_chu;?></span>
                                        </div></div>
                                        ...
                                        <div class="position-relative row form-check">
                                            <div class="" style="text-align: right; margin-right: 15px;">
                                                ...
                                                <a href="<?=base_url();?>admin/quan_tri_chu_nuoi/sua/<?=$chu_nuoi->id;?>" class="btn btn-danger">Sửa thông tin</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
