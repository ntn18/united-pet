                            ...
                            <div class="main-card mb-12 card">
                                <div class="card-body"><h5 class="card-title">THÊM MỚI TIN TỨC</h5>
                                    ...
                                    <form method="POST" enctype="multipart/form-data" action="<?=base_url().'admin/quan_tri_tin_tuc/thuc_hien_them_moi_tin_tuc';?>">
                                        ...
                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-4 col-form-label">Loại tin</label>
                                            <div class="col-sm-8">

                                            <select id="txtLoaiTinTuc" name="txtLoaiTinTuc" class="form-control">
                                            <?php 
                                                // Hiển thị ra được loại tin tức (thông qua câu lệnh lặp)

                                                foreach ($loai_tin_tuc as $loai_tin) {
                                            ;?>
                                                <option value="<?=$loai_tin->id;?>"><?=$loai_tin->ten_loai_tin_tuc;?></option>
                                            <?php
                                                }
                                            ;?>
                                            </select>
