                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="main-card mb-12 card" style="width:100%">
                                <div class="card-body"><h5 class="card-title" style="font-size:20px;">THÊM MỚI TIN TỨC</h5>
                                    <div>
                                    <form method="POST" enctype="multipart/form-data" action="<?=base_url().'admin/quan_tri_tin_tuc/thuc_hien_them_moi_tin_tuc';?>">
                                        ...
                                        <div class="position-relative row form-check">
                                            <div class="" style="text-align: right; margin-right: 15px;">
                                                ...
                                                <button class="btn btn-danger" onclick="alert('Bài viết đã được thêm mới thành công!')">Xác nhận</button>
                                            </div>
                                        </div>
                                    </form>
                                    </div>
